		...
		while ($registro = mysqli_fetch_array($resultado_id, MYSQLI_ASSOC)) {
			echo ' <a href="#" class="list-group-item"> ';
				...
				echo '<p class="list-group-item-text pull-right">';
				  ...
				  echo '<button type="button" id="seguir_'.$registro['id'].'" style="display:'.$btn_seguir_display.'" class="btn btn-default btn_seguir" data-id_user="'.$registro['id'].'">Seguir</button>';
				  echo '<button type="button" id="deixar_seguir_'.$registro['id'].'" style="display:'.$btn_deixar_seguir_display.'" class="btn btn-primary btn_deixar_seguir" data-id_user="'.$registro['id'].'">Deixar de Seguir</button>';
				echo '</p>';
